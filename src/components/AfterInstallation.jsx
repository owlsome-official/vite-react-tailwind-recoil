    ...
    <div className="w-full bg-gradient-to-l from-[#fff] to-[#fff] p-1.5">
      <div className="relative p-8">
        <div className="mb-4 flex flex-col justify-between sm:flex-row">
          ...
          <div className="flex flex-col items-end gap-2.5 text-small">
            <div className="flex gap-1 rounded-full bg-gradient-to-r from-[#CA848A] to-[#FFBE98] px-4 py-0.5 text-neutral">
        ...
        <div className="mx-auto mb-4 w-full max-w-xs rounded-xl bg-gradient-to-r from-[#CA848A] to-[#FFBE98] p-1.5 text-center shadow-lg">
          <div className="flex flex-col items-center">
            ...
            <div className="w-full rounded-lg bg-base-100 p-1">
